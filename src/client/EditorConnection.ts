...
class State {
  edit: EditorState | null | undefined
  comm: string | null | undefined

  constructor(edit: EditorState | null | undefined, comm: string | null | undefined) {
    this.edit = edit
    this.comm = comm
  }
}
class EditorConnection {
  ...
  dispatch = (action: any): void => {
    let newEditState: EditorState<any> | null = null
  ...
  send(editState: EditorState, sendable: any) {
